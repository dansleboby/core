...
<form method="post" action="<? echo implode('/', $_GET['qs']); ?>">
	...
	<input type="date" class="text" placeholder="Date de début (YYYY-MM-DD) - laissez vide si immédiat" name="date_debut" id="date_debut" value="<?php echo $data['date_debut']; ?>">

	<input type="date" class="text" placeholder="Date de début (YYYY-MM-DD) - laissez vide si aucun" name="date_fin" id="date_fin" value="<?php echo $data['date_fin']; ?>">

	<a class="cancel" href="#">Annuler</a>

	<?php
		echo '<a class="delete openInMenuBar" href="admin/groupes/'.$_GET['qs'][2].'/message/delete">Supprimer le message</a>';
	?>
</form>